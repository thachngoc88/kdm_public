...
var handleScrollToTopButton = function() {
    ...
    $(document).scroll( function(e) {
        ...
        if (totalScroll >= 200) {
            ...
            $('[data-click=scroll-bottom]').removeClass('in');
        } else {
            $('[data-click=scroll-top]').removeClass('in');
            $('[data-click=scroll-bottom]').addClass('in');
        }
    });

    var $body = $('body');
    $body.on('click', 'a.in[data-click=scroll-top]', function(e) {
        e.preventDefault();
        $('html, body').animate({
            scrollTop: $body.offset().top
        }, 500);
    });
    $body.on('click', 'a.in[data-click=scroll-bottom]', function(e) {
        e.preventDefault();
        $('html, body').animate({
